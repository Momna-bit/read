...
-- CONNECTION NOTE: both BAT_SMT and the iSigma tables now use three-part
-- naming (Care_BillAnalyzerTool_WH.dbo.BAT_SMT and
-- Analytics_ConstellationWH.dbo.iSigma_*), so this script should run
-- regardless of which warehouse your connection defaults to -- as long as
-- both warehouses live in the same Fabric workspace as your connection.
