...
SELECT
      Language
    , DATEADD(MINUTE, (DATEDIFF(MINUTE, CAST('1900-01-01' AS datetime2), CallDate) / 15) * 15, CAST('1900-01-01' AS datetime2)) AS Interval15Min
    , COUNT(*) AS CallCount
INTO #IVR15min
FROM #IVRRaw
GROUP BY
      Language
    , DATEADD(MINUTE, (DATEDIFF(MINUTE, CAST('1900-01-01' AS datetime2), CallDate) / 15) * 15, CAST('1900-01-01' AS datetime2));
...
SELECT
      Language
    , DATEADD(MINUTE, (DATEDIFF(MINUTE, CAST('1900-01-01' AS datetime2), CallDate) / 30) * 30, CAST('1900-01-01' AS datetime2)) AS Interval30Min
    , COUNT(*) AS CallCount
INTO #IVR30min
FROM #IVRRaw
GROUP BY
      Language
    , DATEADD(MINUTE, (DATEDIFF(MINUTE, CAST('1900-01-01' AS datetime2), CallDate) / 30) * 30, CAST('1900-01-01' AS datetime2));
