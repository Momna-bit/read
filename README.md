...
-- ============================================================================
-- STEP 3: Full 12-month accuracy summary (MAPE + % of days within range)
-- Uses the corrected RecentRates and SeasonalIndex
-- ============================================================================
...
-- ============================================================================
-- Daily forecast, split by credit tier — CORRECTED VERSION
-- Uses validated 12-month day-of-week rates and seasonal index
-- Currently: next 184 days from today — adjust the WHERE OffsetDay < 184 line to extend
-- ============================================================================
